...
class __TwigTemplate_be9b9372fbaec2f17ff2252716cf8e0f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/d8w3css/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal-9.5.7\\themes\\contrib\\d8w3css\\templates\\content-edit\\filter-tips.html.twig");
    }
